...
//    FOREIGN KEY(liking_mem_no) REFERENCES MEMBER(mem_no)
	...
	public String toString() {
		return "Likes [like_no=" + like_no + ", board_no=" + board_no + ", post_no=" + post_no + ", cmt_check="
				+ cmt_check + ", cmt_no=" + cmt_no + ", liker_mem_no=" + liker_mem_no + ", liking_mem_no="
				+ liking_mem_no + ", like_del_check=" + like_del_check + "]";
	}
