...
//	FOREIGN KEY(mem_no) REFERENCES MEMBER(mem_no)
    ...
    public Post(int post_type, int board_no, int mem_no, String post_title, String post_content, String post_category,
		boolean post_secret, boolean post_notice, String post_start_day, String post_end_day, String post_plan) {
	super();
	...
	public String toString() {
		return "Post [post_no=" + post_no + ", post_type=" + post_type + ", board_no=" + board_no + ", mem_no=" + mem_no
				...
				+ ", post_notice=" + post_notice + ", post_start_day=" + post_start_day + ", post_end_day="
				+ post_end_day + ", post_plan=" + post_plan + ", post_del_check=" + post_del_check + "]";
	}
