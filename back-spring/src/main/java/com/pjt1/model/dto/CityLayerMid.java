...
//    FOREIGN KEY(clt_no) REFERENCES CITY_LAYER_TOP(clt_no)
    ...
    public CityLayerMid(int clt_no, String clm_name, String clm_address, String clm_img, String clm_content, int clm_type,
    		String clm_character, String clm_subtitle) {
    	super();
    	this.clt_no = clt_no;
    ...
    public String toString() {
    	return "CityLayerMid [clm_no=" + clm_no + ", clt_no=" + clt_no + ", clm_name=" + clm_name + ", clm_address="
    			...
    			+ ", clm_character=" + clm_character + ", clm_subtitle=" + clm_subtitle + "]";
    }
