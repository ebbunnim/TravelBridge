...
//    FOREIGN KEY(mem_no) REFERENCES MEMBER(mem_no)
	...
	public Qna(int mem_no, String qna_title, String qna_content) {
		super();
		this.mem_no = mem_no;
	...
	public String toString() {
		return "Qna [qna_no=" + qna_no + ", mem_no=" + mem_no + ", qna_title=" + qna_title + ", qna_content=" + qna_content
				+ ", qna_hits=" + qna_hits + ", qna_regtime=" + qna_regtime + ", qna_secret=" + qna_secret
