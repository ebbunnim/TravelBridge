...
public class Comment implements Serializable {
	...
	@NonNull @Getter @Setter private int post_no;// int NOT NULL, # 게시물 번호 외래키
	@NonNull @Getter @Setter private int mem_no;// int NOT NULL, # 게시글 작성자 번호 외래키
	@Getter @Setter private String cmt_regtime;// datetime, # 댓글 작성 일시
	@Getter @Setter private String cmt_content;// varchar(3000), # 댓글 내용
	@Getter @Setter private String cmt_writer;
