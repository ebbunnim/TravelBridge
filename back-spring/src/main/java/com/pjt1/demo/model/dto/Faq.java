...
public class Faq implements Serializable {
	...
	private String faq_category	;//varchar(100),			# 질문 카테고리	
	...
	public Faq(String faq_category, String faq_title, String faq_content, String faq_answer) {
		super();
	...
	public Faq(int faq_no, String faq_category, String faq_title, String faq_content, String faq_answer, int faq_hits,
			String faq_regtime, boolean faq_del_check) {
		super();
		this.faq_no = faq_no;
		this.faq_category = faq_category;
		this.faq_title = faq_title;
	...
	public String toString() {
		return "Faq [faq_no=" + faq_no + ", faq_category=" + faq_category + ", faq_title=" + faq_title
				+ ", faq_content=" + faq_content + ", faq_answer=" + faq_answer + ", faq_hits=" + faq_hits
				+ ", faq_regtime=" + faq_regtime + ", faq_del_check=" + faq_del_check + "]";
	}
