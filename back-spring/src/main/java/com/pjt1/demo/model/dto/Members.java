...
public class Members implements Serializable {
	...
	@NonNull @Getter@Setter private String mem_id;		// varchar( 50) NOT NULL UNIQUE, # 아이디
	@NonNull @Getter@Setter private String mem_email;	// varchar(150) NOT NULL UNIQUE, # 이메일
	@NonNull @Getter@Setter private String mem_phone;	// varchar( 50) NOT NULL UNIQUE, # 핸드폰번호
	...
	@Getter@Setter private boolean mem_del_check;		// boolean DEFAULT FALSE # 삭제 여부
