...
public class Follow implements Serializable {
	...
	@NonNull @Getter @Setter private int follower_no ;	// int NOT NULL, # 팔로우 하는 회원 외래키
	@NonNull @Getter @Setter private int following_no;	// int NOT NULL, # 팔로우 당하는 회원 외래키
	@Getter @Setter private boolean follow_del_check ;	// boolean DEFAULT FALSE, # 삭제 여부
	@Getter@Setter private List<Members> followList;
