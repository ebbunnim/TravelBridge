...
public class Likes implements Serializable {
	...
	@Getter
	@Setter
	private int like_type; // int NOT NULL, # 좋아요 위치(1:게시물,2:핫플,3:축제)
	@Getter
	@Setter
	private int post_no; // int DEFAULT 0, # 게시물 번호
	@Getter
	@Setter
	private int hotplace_no; // int DEFAULT 0, # 핫플 번호
	@Getter
	@Setter
	private int festival_nol; // int DEFAULT 0, # 축제번호
	@Getter
	@Setter
