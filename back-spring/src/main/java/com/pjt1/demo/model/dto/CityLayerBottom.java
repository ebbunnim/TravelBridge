...
public class CityLayerBottom implements Serializable {
	...
	public CityLayerBottom(int clb_no, int clm_no, String clb_name, String clb_address, String clb_img,
			String clb_content, String clb_tag, String clb_character, String clb_subtitle, String clb_fun,
			String clb_spot, boolean clb_del_check) {
		super();
		this.clb_no = clb_no;
		this.clm_no = clm_no;
		this.clb_name = clb_name;
		...
		this.clb_fun = clb_fun;
		this.clb_spot = clb_spot;
		this.clb_del_check = clb_del_check;
	}
	...
	public boolean isClb_del_check() {
		return clb_del_check;
	}

	public void setClb_del_check(boolean clb_del_check) {
		this.clb_del_check = clb_del_check;
	}
