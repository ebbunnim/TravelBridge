...
//	FOREIGN KEY(post_no) REFERENCES POST(post_no)
	...
	public Files(int post_no, String files_name, boolean files_thumbnail, String files_url) {
		super();
	...
	public String toString() {
		return "Files [files_no=" + files_no + ", post_no=" + post_no + ", files_name=" + files_name
				+ ", files_thumbnail=" + files_thumbnail + ", files_url=" + files_url + ", files_del_check="
				+ files_del_check + "]";
	}
