...
public class Festival implements Serializable {
	...
	@Getter
	@Setter
	private String fval_detail_adr;// varchar(500) NOT NULL,
	@NonNull
	@Getter
	@Setter
	...
	@Getter
	@Setter
	private String fval_fee;// int DEFAULT 0,
	@Getter
	@Setter
	...
	@Getter
	@Setter
	private String fval_theme; // varchar(500), # 축제 테마
	@Getter
	@Setter
	private boolean fval_ended; // boolean DEFAULT FALSE, # 축제 종료여부
	@Getter
	@Setter
