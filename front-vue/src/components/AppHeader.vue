        ...
        <q-menu square v-model="menuOn2" @mouseleave="menuOn2 = false" class="gt-sm" fit>
          <q-list class="q-ma-sm">
            ...
            <div class="row justify-center">
              ...
              <q-btn to="/page2/pick" flat class="col-3">테마별 여행지 추천</q-btn>
              <q-btn to="/page2/list" flat class="col-3">여행지 정보 검색</q-btn>
              <q-btn to="/page2/main2search" flat class="col-3" icon="search">삭제할 것</q-btn>
            </div>
          </q-list>
        </q-menu>
