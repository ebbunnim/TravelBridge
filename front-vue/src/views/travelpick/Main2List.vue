<template>
  <q-page class="page">
    ...
    <q-img style="height: 300px" :src="getImgUrl('cutbg.jpg')" class="q-mb-xl">
      <div style="height: 100%; width: 100%;"  class="row justify-center items-center q-mb-xl">
        <div class="col-12 text-h4 text-center text-weight-bold text-white">여행지 정보 검색</div>
        <q-select
          wrap
          rounded
          bg-color="grey"
    ...
    <div class="row justify-center">
      <div v-if="hp_list_length > 0" class="col-12 text-center text-h6">#{{ searchTitle }} 핫플레이스</div>
      <div
        v-else-if="hp_list_length === 0"
        class="col-12 text-center text-h6"
      >{{ searchTitle }} 핫플레이스 검색 결과가 없습니다.</div>
      <!-- 카드가 들어가는 부분 -->
      <HotPlaceCard
    ...
    <div class="q-mt-xl q-pt-xl">
      <div class="row justify-center">
        <div v-if="fval_list_length > 0" class="col-12 text-center text-h6">#{{ searchTitle }} 페스티벌</div>
        <div
          v-else-if="fval_list_length === 0"
          class="col-12 text-center text-h6"
        >{{ searchTitle }} 페스티벌 검색 결과가 없습니다.</div>
        <!-- 카드가 들어가는 부분 -->
        <FestivalCard
