...
#### - **사용자 접근편의성 향상 (Trip to Person)**
 - 여행 준비 단계에서 필요한 정보나 후기를 One stop 으로 제공해
사용자 접근평의성 향상


#### - **SNS 가 가져오는 홍보 효과 (Person to Person)** 
 - 타인과 여행 경험을 공유 , 친목을 도모할 기회는 신규 고객을 유인할 계기

#### - **선순환적 서비스 이용 (Trip to Trip)**   
 - 과거 현재 미래의 여행경험을 통합함 사용자의 재방문 의사를 높임
...
## **개발일정 진행과정**
![ganttchart](./metadata_description/Gantt_chart.png)
